...
export const verticalMenuItems = [
    new Menu (14, 'acceuil', '/home', "", 'folder-open-o', null, false,0),
    new Menu (1, 'Contact A-Z', '/contact', "", 'folder-open-o', null, true, 0),
    new Menu (2, 'Fournisseurs', '/contactFournisseur', null, 'folder-open-o', null, false, 1),
    new Menu (3, 'Clients', '/contactClient', null, 'folder-open-o', null, false, 1),
    new Menu (4, 'Partenaires', '/contactPartenaire', null, 'folder-open-o', null, false, 1),
    new Menu (5, 'Administration', null, "", 'folder-open-o', null, true,0),
    new Menu (9, 'Keywords', '/keyword', null, 'key', null, false, 5),
    new Menu (6, 'Corbeille', null, "", 'folder-open-o', null, true,5),
    new Menu (7, 'Contact', '/corbeille', null, 'trash', null, false, 6),
    new Menu (8, 'KeyWord', '/corbeille', null, 'trash', null, false, 6),
    new Menu (15, 'Sociétés', null, "", 'folder-open-o', null, true,0),
    new Menu (16, 'parametres', null, "", 'folder-open-o', null, false,0),
...
export const horizontalMenuItems = [ 
  //  new Menu (1, 'Contact', '/contact', null, 'folder-open-o', null, false, 0),
    /* new Menu (1, 'Dashboard', '/', null, 'tachometer', null, false, 0),
    new Menu (2, 'Membership', '/membership', null, 'users', null, false, 0), 
    new Menu (3, 'UI Features', null, null, 'laptop', null, true, 0),   
    new Menu (4, 'Buttons', '/ui/buttons', null, 'keyboard-o', null, false, 3),  
