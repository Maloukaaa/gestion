  ...
  onToolbarPreparing(e) {
    ...
    e.toolbarOptions.items.unshift(
      ...
      if(this.canAdd() ){
        ...
        this.translate.get("CM.create2").subscribe((res) => {
          e.toolbarOptions.items.unshift(
              {
                  location: 'after',
                  widget: 'dxButton',
...
ouvrir(e)
{
   ...
   this.router.navigate(["/ajout-keyword"])
}
  refreshDataGrid() {
  ...
  this.dataSource2 = new CustomStore({
    ...
    load: function (loadOptions: any) {
     ...
     //loadOptions.select= "id";
        var params = "";
//console.log("ddd "+this.loginComponent.total);
        ...
        {
          //console.log(loadOptions.take+" "+loadOptions.skip)
        ...
        if (loadOptions.sort) {
            ...
            if (loadOptions.sort[0].desc) {
                if ((loadOptions.sort[0].selector == "dateCreated")  || (loadOptions.sort[0].selector == "id") || (loadOptions.sort[0].selector == "codePostal") )
...
console.log(params);
  ...
  public goEdit(e,id)
    {
      setTimeout(()=>{
        this.router.navigate(["/edit-keyword/"+id])
      },1000)
    ...
    public goShow(e,id)
    {
      this.router.navigate(["/show-keyword/"+id])
    }
  ...
  this.translate.get("CM.defSupK").subscribe(
    ...
    Swal.fire({
        ...
        if (result.value) {
          ...
          this.keywordService.deleteKeyword2(id);
